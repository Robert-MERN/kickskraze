...
const collection = ({ logoUrl, fullUrl }) => {
    return (
        <>
            <Head>
                <title>Kickskraze | Collection | Footwear</title>
                <meta property="og:title" content="Kickskraze | Collection | Footwear" />
                <meta property="og:description" content="Footwear Collection Page" />
                <meta property="og:image" content={logoUrl} />
                <meta property="og:url" content={fullUrl} />
                <meta property="og:type" content="footwear collection" />
                <link rel="icon" href="/images/icon.png" />
            </Head>
            <div className='w-screen flex flex-col items-center'>
                <Navbar axios={axios} />
                <div className='w-full min-h-[calc(100vh-70px)] 2xl:w-[1650px] xl:w-[1400px] lg:w-[1100px] lg:px-[40px]' >
                    <Collection_page storeName="Footwear" axios={axios} />
                </div>
                <App_footer />
                <Footer />
            </div>
