    ...
    return (
        <>
            <Head>
                ...
                <meta property="og:title" content="Kickskraze | Admin | Analytics" />
                <meta property="og:description" content="Admin / Analytics Page" />
                <meta property="og:image" content={logoUrl} />
                <meta property="og:url" content={fullUrl} />
                <meta property="og:type" content="admin - analytics" />
                <link rel="icon" href="/images/icon.png" />
            </Head>
            <div className='w-screen flex flex-col items-center'>
                <Admin_navbar />
                <div className='w-full mt-[70px]' >
                    <Admin_page_layout admin_children={<Analytics axios={axios} user={user} />} />
                </div>
            </div>
        </>
    )
