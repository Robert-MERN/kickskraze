    ...
    return (
        <>
            <Head>
                ...
                <meta property="og:title" content="Kickskraze | Admin | Update Product" />
                <meta property="og:description" content="Admin / Update Product Page" />
                <meta property="og:image" content={logoUrl} />
                <meta property="og:url" content={fullUrl} />
                <meta property="og:type" content="admin - update product" />
