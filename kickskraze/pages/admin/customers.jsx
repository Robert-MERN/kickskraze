...
export default function Home({ fullUrl, logoUrl, user }) {
    ...
    return (
        <>
            <Head>
                <title>Kickskraze | Admin | Customers</title>
                <meta property="og:title" content="Kickskraze | Admin | Customers" />
                <meta property="og:description" content="Admin / Customers Page" />
                <meta property="og:image" content={logoUrl} />
                <meta property="og:url" content={fullUrl} />
                <meta property="og:type" content="admin - customers" />
                <link rel="icon" href="/images/icon.png" />
            </Head>
            <div className='w-screen flex flex-col items-center'>
                <Admin_navbar />
                <div className='w-full mt-[70px]' >
                    <Admin_page_layout admin_children={<Customers axios={axios} />} />
                </div>
            </div>
        </>
    )
