...
export default function Home({ fullUrl, logoUrl, user }) {
    ...
    return (
        <>
            <Head>
                <title>Kickskraze | Admin | Dispatched Orders | Footwear</title>
                <meta property="og:title" content="Kickskraze | Admin | Dispatched Orders | Footwear" />
                <meta property="og:description" content="Admin | Dispatched Orders Page | Footwear" />
                <meta property="og:image" content={logoUrl} />
                <meta property="og:url" content={fullUrl} />
                <meta property="og:type" content="admin - dispatched orders - footwear" />
                <link rel="icon" href="/images/icon.png" />
            </Head>
            <div className='w-screen flex flex-col items-center'>
                <Admin_navbar />
                <div className='w-full mt-[70px]' >
                    <Admin_page_layout admin_children={<Dispatched_orders axios={axios} storeName="Footwear" />} />
                </div>
            </div>
        </>
    )
