...
export default function Home({ fullUrl, logoUrl, user }) {
    ...
    return (
        <>
            <Head>
                <title>Kickskraze | Admin | Orders | Apparel</title>
                <meta property="og:title" content="Kickskraze | Admin | Orders | Apparel" />
                <meta property="og:description" content="Admin | Orders Page | Apparel" />
                <meta property="og:image" content={logoUrl} />
                <meta property="og:url" content={fullUrl} />
                <meta property="og:type" content="admin - orders - apparel" />
                <link rel="icon" href="/images/icon.png" />
            </Head>
            <div className='w-screen flex flex-col items-center'>
                <Admin_navbar />
                <div className='w-full mt-[70px]' >
                    <Admin_page_layout admin_children={<Orders axios={axios} storeName="Apparel" />} />
                </div>
            </div>
        </>
    )
