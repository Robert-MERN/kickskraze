...
import Update_user from '@/components/admin_pages/Update_user'
...
export default function Home({ fullUrl, logoUrl, user }) {
    ...
    return (
        <>
            <Head>
                <title>Kickskraze | Admin | Update User</title>
                <meta property="og:title" content="Kickskraze | Admin | Update User" />
                <meta property="og:description" content="Admin / Update User Page" />
                <meta property="og:image" content={logoUrl} />
                <meta property="og:url" content={fullUrl} />
                <meta property="og:type" content="admin - update user" />
                <link rel="icon" href="/images/icon.png" />
            </Head>
            <div className='w-screen flex flex-col items-center'>
                <Admin_navbar />
                <div className='w-full mt-[70px]' >
                    <Admin_page_layout admin_children={<Update_user axios={axios} user={user} />} />
                </div>
            </div>
        </>
    )
