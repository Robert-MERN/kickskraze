...
export default function Home({ fullUrl, logoUrl, user }) {
    ...
    return (
        <>
            <Head>
                <title>Kickskraze | Admin | All Products | Footwear Accessories</title>
                <meta property="og:title" content="Kickskraze | Admin | All Products | Footwear Accessories" />
                <meta property="og:description" content="Admin | All Products Page | Footwear Accessories" />
                <meta property="og:image" content={logoUrl} />
                <meta property="og:url" content={fullUrl} />
                <meta property="og:type" content="admin - all products - footwear accessories" />
                <link rel="icon" href="/images/icon.png" />
            </Head>
            <div className='w-screen flex flex-col items-center'>
                <Admin_navbar />
                <div className='w-full mt-[70px]' >
                    <Admin_page_layout admin_children={<All_products axios={axios} storeName="Footwear-accessories" />} />
                </div>
            </div>
        </>
    )
