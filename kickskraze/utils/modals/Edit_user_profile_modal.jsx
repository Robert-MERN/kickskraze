...
const Edit_user_profile_modal = ({
    ...
    useEffect(() => {
        if (modals_state.edit_user_profile_modal) {
            get_user_api(axios, modal_user_id, set_user_details, set_is_loading);
        }

    }, [modals_state.edit_user_profile_modal]);
    ...
    return (
        <Dialog
            open={modals_state.edit_user_profile_modal}
            onClose={close_modal}
            className=''
        >
            <div className={`min-w-[300px] md:w-[550px] ${styles.scroll_bar} overflow-x-hidden`} >
                                ...
                                <form onSubmit={handle_submit} className="flex-[1] md:px-[20px] py-[20px] flex flex-col gap-y-6">
                                    ...
                                    <div className='w-full flex justify-between items-center'>
                                        ...
                                        <div className="w-full flex justify-end my-[30px] gap-2 lg:gap-4">
                                            <button type="button" onClick={close_modal} className='w-fit px-[8px] lg:px-[18px] py-[6px] bg-stone-400 text-white hover:opacity-75 active:opacity-50 transition-all text-nowrap rounded text-[12px] md:text-[14px]'>
                                                Cancel
                                            </button>
...
export default Edit_user_profile_modal