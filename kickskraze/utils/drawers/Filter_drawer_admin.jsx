...
const Filter_drawer_admin = ({ drawer_state, toggle_drawer, axios }) => {
    ...
    useEffect(() => {
        if (drawer_state.filter_drawer_admin && !Object.entries(filter_options).length) {
            get_filter_values_api(axios, set_filter_options, set_filter_options_loading);
        }
    }, [drawer_state.filter_drawer_admin]);
        ...
        >
            <div className='w-[75vw] pt-[10px] pb-[40px] text-stone-950 transition-all duration-300'>
                ...
                <div className='flex justify-between w-full items-center py-[12px] px-[15px]' >
                    ...
                    <button onClick={() => toggle_drawer("filter_drawer_admin")} className='active:opacity-75' >
                                ...
                                <div className='mt-[20px] mb-[50px] w-full'>
                                    <button
                                        onClick={() => {
                                            ...
                                            toggle_drawer("filter_drawer_admin");
                                        }}
...
export default Filter_drawer_admin