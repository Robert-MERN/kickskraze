...
const Sort_popover = ({ anchorEl, close, sort_options, filters, set_filters }) => {
    ...
    return (
        ...
        >
            ...
            <div className={`w-[230px] py-[15px] bg-white rounded-md tracking-wider text-stone-950 transition-all duration-300`} >
        ...
        <div className='w-full px-[20px] pt-[15px] md:pt-[30px] tracking-wider'>
            <div className='w-full flex gap-4' >
                ...
                <div className='flex-[5]'>
                    ...
                    {/* Header */}
                    <div className='w-full flex justify-between items-center py-[15px] lg:py-0 lg:mb-[30px] sticky lg:static top-0 bg-white z-10 lg:z-0' >
                    ...
                    <div className='my-[50px] w-full flex justify-center items-center'>
                        <button onClick={fetch_filter} className='font-extrabold text-black hover:text-white active:opacity-50 transition-all py-[12px] w-full md:w-[300px] hover:bg-black bg-white border border-stone-400 duration-300' >
                            Show More
                        </button>
                    </div>
